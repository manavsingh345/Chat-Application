...
<div className="relative inline-flex items-center justify-center gap-4 group" onClick={onClick}>
  ...
  <a
    role="button"
    className="group relative inline-flex items-center justify-center text-base rounded-xl bg-gray-900 px-8  py-3 font-semibold font-serif text-white transition-all duration-200 hover:bg-gray-800 hover:shadow-lg hover:-translate-y-0.5 hover:shadow-gray-600/30"
    title="payment"
    href="#"
    >Create New Room<svg
      aria-hidden="true"
